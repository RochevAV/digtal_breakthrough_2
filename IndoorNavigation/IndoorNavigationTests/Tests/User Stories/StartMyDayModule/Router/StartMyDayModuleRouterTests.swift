//
//  StartMyDayModuleRouterTests.swift
//  IndoorNavigation
//
...
final class StartMyDayModuleRouterTests: XCTestCase {

	// MARK: - Properties

    private var view: MockModuleTransitionable?
    private var router: StartMyDayModuleRouter?

    // MARK: - XCTestCase

    override func setUp() {
        super.setUp()
        router = StartMyDayModuleRouter()

//
//  TaskForDayModuleRouterTests.swift
//  IndoorNavigation
//
...
final class TaskForDayModuleRouterTests: XCTestCase {

	// MARK: - Properties

    private var view: MockModuleTransitionable?
    private var router: TaskForDayModuleRouter?

    // MARK: - XCTestCase

    override func setUp() {
        super.setUp()
        router = TaskForDayModuleRouter()

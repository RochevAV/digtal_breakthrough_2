//
//  MyTaskOnLocationModuleRouterTests.swift
//  IndoorNavigation
//
...
final class MyTaskOnLocationModuleRouterTests: XCTestCase {

	// MARK: - Properties

    private var view: MockModuleTransitionable?
    private var router: MyTaskOnLocationModuleRouter?

    // MARK: - XCTestCase

    override func setUp() {
        super.setUp()
        router = MyTaskOnLocationModuleRouter()

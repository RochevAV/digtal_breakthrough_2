//
//  TasksOnLocationModuleRouterTests.swift
//  IndoorNavigation
//
...
final class TasksOnLocationModuleRouterTests: XCTestCase {

	// MARK: - Properties

    private var view: MockModuleTransitionable?
    private var router: TasksOnLocationModuleRouter?

    // MARK: - XCTestCase

    override func setUp() {
        super.setUp()
        router = TasksOnLocationModuleRouter()
